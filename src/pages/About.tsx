...
export default function About() {
    return (
        <>
            ...
            <h4>Pages:</h4>
            <p>
                <Link to="/">Main</Link> - you go to this page after sign in. You could add outlays and incomes by form fields and see
            ...
            <p>
                <Link to="/statistic">Statistic</Link> - provides functionality to see all outlays by last week, last month and between nay
